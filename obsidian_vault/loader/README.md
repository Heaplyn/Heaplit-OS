...
- **Purpose**: Assembles `rings/ring_3/boot/base.asm` with NASM, includes all ring directories, checks output binary size, terminates any running QEMU instances, and boots Heaplit OS in QEMU.
- **Usage**:
  ```powershell
  .\loader\load_os.ps1
  ```

...
## 🔄 Global Include Dependency Graph

```mermaid
flowchart TD
    A["include/base_system.inc"] --> B["Ring 0 Kernel Types"]
    A --> C["System V ABI Calling Convention Macros"]
    A --> D["Real Mode Segment Constants"]
```

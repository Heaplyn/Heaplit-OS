...
## 2. Related Links
- [[02 - Ring 1 - The C Overhead (Bridge)/ring_1/drivers/03 - Virtual File System (VFS)|VFS Specification]]
- [[02 - Ring 1 - The C Overhead (Bridge)/ring_1/drivers/05 - Device Drivers (PCIe, NVMe, USB)|Device Drivers]]
...
Heaplit OS enforces strict register management conventions for **04 - FAT32 & EXT4 Drivers** across all x86-64 execution contexts:
...
The virtual address space for **04 - FAT32 & EXT4 Drivers** adheres to Heaplit OS's canonical higher-half memory layout:
...
The low-level assembly implementation of **04 - FAT32 & EXT4 Drivers** uses canonical NASM syntax optimized for x86-64 execution:

```nasm
; ============================================================================
; Heaplit OS Low-Level Core Blueprint - 04 - FAT32 & EXT4 Drivers
; ============================================================================
%include "ring_0/types/variable.asm"

global 04___fat32___ext4_drivers_entry
...
align 16
04___fat32___ext4_drivers_entry:
    push rbp
    mov rbp, rsp
...
section .rodata
msg_success: db "[HEAPLIT] 04 - FAT32 & EXT4 Drivers Subsystem initialized at physical address: 0x%x", 10, 0
```
...
To test **04 - FAT32 & EXT4 Drivers** within the Heaplit OS kernel binary (`base.bin`), execute the host automated build script:
...
During execution, **04 - FAT32 & EXT4 Drivers** outputs diagnostic traces to COM1 Serial Port (`0x3F8`). Verified serial outputs must confirm:

...
## 2. Related Links
- [[01 - Ring 0 - Metal Core (Assembly)/ring_0/standards/01 - Boot Sequence & Staged Loading|Boot Sequence]]
- [[02 - Ring 1 - The C Overhead (Bridge)/ring_1/drivers/04 - FAT32 & EXT4 Drivers|FAT32 Driver]]
...
Heaplit OS enforces strict register management conventions for **06 - Disk & Storage Utilities** across all x86-64 execution contexts:
...
The virtual address space for **06 - Disk & Storage Utilities** adheres to Heaplit OS's canonical higher-half memory layout:
...
The low-level assembly implementation of **06 - Disk & Storage Utilities** uses canonical NASM syntax optimized for x86-64 execution:

```nasm
; ============================================================================
; Heaplit OS Low-Level Core Blueprint - 06 - Disk & Storage Utilities
; ============================================================================
%include "ring_0/types/variable.asm"

global 06___disk___storage_utilities_entry
...
align 16
06___disk___storage_utilities_entry:
    push rbp
    mov rbp, rsp
...
section .rodata
msg_success: db "[HEAPLIT] 06 - Disk & Storage Utilities Subsystem initialized at physical address: 0x%x", 10, 0
```
...
To test **06 - Disk & Storage Utilities** within the Heaplit OS kernel binary (`base.bin`), execute the host automated build script:
...
During execution, **06 - Disk & Storage Utilities** outputs diagnostic traces to COM1 Serial Port (`0x3F8`). Verified serial outputs must confirm:

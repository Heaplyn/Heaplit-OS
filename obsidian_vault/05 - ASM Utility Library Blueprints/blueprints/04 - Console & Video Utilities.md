...
## 2. Related Links
- [[02 - Reference/api/Console & Display API|Console API Reference]]
- [[05 - ASM Utility Library Blueprints/blueprints/05 - Keyboard & Input Service|Keyboard Service]]
...
Heaplit OS enforces strict register management conventions for **04 - Console & Video Utilities** across all x86-64 execution contexts:
...
The virtual address space for **04 - Console & Video Utilities** adheres to Heaplit OS's canonical higher-half memory layout:
...
The low-level assembly implementation of **04 - Console & Video Utilities** uses canonical NASM syntax optimized for x86-64 execution:

```nasm
; ============================================================================
; Heaplit OS Low-Level Core Blueprint - 04 - Console & Video Utilities
; ============================================================================
%include "ring_0/types/variable.asm"

global 04___console___video_utilities_entry
...
align 16
04___console___video_utilities_entry:
    push rbp
    mov rbp, rsp
...
section .rodata
msg_success: db "[HEAPLIT] 04 - Console & Video Utilities Subsystem initialized at physical address: 0x%x", 10, 0
```
...
To test **04 - Console & Video Utilities** within the Heaplit OS kernel binary (`base.bin`), execute the host automated build script:
...
During execution, **04 - Console & Video Utilities** outputs diagnostic traces to COM1 Serial Port (`0x3F8`). Verified serial outputs must confirm:

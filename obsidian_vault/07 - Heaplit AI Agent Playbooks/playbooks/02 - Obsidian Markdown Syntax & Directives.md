...
## 3. Related Links
- [[07 - Heaplit AI Agent Playbooks/playbooks/01 - Autonomous Build & Test Loop|Build Loop]]
- [[00 - Architecture/tooling/Obsidian Integration & 2-Way Sync|Obsidian 2-Way Sync]]
...
Heaplit OS enforces strict register management conventions for **02 - Obsidian Markdown Syntax & Directives** across all x86-64 execution contexts:
...
The virtual address space for **02 - Obsidian Markdown Syntax & Directives** adheres to Heaplit OS's canonical higher-half memory layout:
...
The low-level assembly implementation of **02 - Obsidian Markdown Syntax & Directives** uses canonical NASM syntax optimized for x86-64 execution:

```nasm
; ============================================================================
; Heaplit OS Low-Level Core Blueprint - 02 - Obsidian Markdown Syntax & Directives
; ============================================================================
%include "ring_0/types/variable.asm"

global 02___obsidian_markdown_syntax___directives_entry
...
align 16
02___obsidian_markdown_syntax___directives_entry:
    push rbp
    mov rbp, rsp
...
section .rodata
msg_success: db "[HEAPLIT] 02 - Obsidian Markdown Syntax & Directives Subsystem initialized at physical address: 0x%x", 10, 0
```
...
To test **02 - Obsidian Markdown Syntax & Directives** within the Heaplit OS kernel binary (`base.bin`), execute the host automated build script:
...
During execution, **02 - Obsidian Markdown Syntax & Directives** outputs diagnostic traces to COM1 Serial Port (`0x3F8`). Verified serial outputs must confirm:

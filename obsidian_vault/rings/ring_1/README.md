...
### 1. `rings/ring_1/hardware/` — Hardware Line Activation
...
### 2. `rings/ring_1/liba/` — Freestanding C Runtime
...
### 3. `rings/ring_1/drivers/` — Device Drivers & Inference Bridge
...
```mermaid
flowchart TD
    R1["rings/ring_1/"] --> HW["hardware/ (Hardware Drivers)"]

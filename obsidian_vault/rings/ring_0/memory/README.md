...
# 🧠 Ring 0 Memory Subsystem (`rings/ring_0/memory/`)
...
```mermaid
flowchart TD
    A["Physical Memory Scan (E820)"] --> B["Initialize PMM Bitmap"]
    B --> C["Setup PML4 4-Level Virtual Page Tables"]
    C --> D["Provide Page Allocation API"]
```

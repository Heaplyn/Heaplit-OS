...
# ⏱️ Ring 0 Scheduler Subsystem (`rings/ring_0/sched/`)
...
```mermaid
flowchart TD
    A["APIC Timer Vector"] --> B["Save Current TCB Context"]
    B --> C["Pick Next Runnable Thread TCB"]
    C --> D["Restore RSP Stack Pointer & `iretq`"]
```

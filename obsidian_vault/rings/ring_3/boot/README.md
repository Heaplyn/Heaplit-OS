...
# 🚀 Ring 3 Bootloader Subsystem (`rings/ring_3/boot/`)
...
## 🔄 Bootloader Multi-Sector Execution

```mermaid
flowchart TD
    A["Sector 1: MBR"] --> B["Sectors 2-3: Extended Diagnostics"]
    B --> C["Sector 4: Interactive Prompt"]
    C --> D["Sectors 5-8: Protected & Long Mode Switch"]
```

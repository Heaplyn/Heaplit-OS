...
gdt_start:
    ...
    dq 0x0000000000000000               ; Execute hardware step
    ...
    dw 0xFFFF                           ; Execute hardware step
    dw 0x0000                           ; Execute hardware step
    db 0x00                             ; Execute hardware step
    ...
    db 00000000b                        ; Execute hardware step
    db 0x00                             ; Execute hardware step
...
gdt_descriptor_64:
    dw gdt_end - gdt_start - 1          ; Execute hardware step
    dq gdt_start                        ;GDT Base Address (64-bit)

; Segment Selector Constants
CODE_SEG_32 equ 0x08                    ; Execute hardware step
DATA_SEG_32 equ 0x10                    ; Execute hardware step
CODE_SEG_64 equ 0x18                    ; Execute hardware step
DATA_SEG_64 equ 0x20                    ; Execute hardware step
USER_DATA_64 equ 0x28 | 3               ; Execute hardware step
USER_CODE_64 equ 0x30 | 3               ; Execute hardware step

...
ring_3_userland_entry:
    ...
    mov rsi, msg_ring3_active           ; Pass source string pointer 'msg_ring3_active' in RSI (System V ABI Arg 2)
    mov rdi, 0xB8000 + (15 * 80 * 2)    ;Row 15, Col 0
    call print_string_64                ; Call subroutine 'print_string_64'

    ; 3. Output Userland Shell Ready
    mov rsi, msg_ring3_shell            ; Pass source string pointer 'msg_ring3_shell' in RSI (System V ABI Arg 2)
